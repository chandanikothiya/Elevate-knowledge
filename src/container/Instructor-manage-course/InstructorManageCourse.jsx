...
import { getcourse } from '../../redux/slice/course.slice';

function InstructorManageCourse(props) {
...
coures.course.map((v) => console.log(v.course_img,v.name))
    ...
    return (
        ...
        //                                             <th scope="col" className="border-0">Catgeory</th>
        ...
        //                                                                         <img src={IMG_URL + v.course_img} className="rounded" alt />
        //                                                                     </div>
        ...
        //                                                                             <p className="h6 fw-light mb-0 small me-3"><i className="fas fa-table text-orange me-2" />{v.week_no + ' Week'}</p>
        //                                                                         </div>
        //                                                                     </div>
        //                                                                 </div>
        //                                                             </td>
        //                                                             {/* Enrolled item */}
        //                                                             {/* <td className="text-center text-sm-start">{}</td> */}
        //                                                             {/* Status item */}
        //                                                             <td>
        //                                                                 <div className="badge bg-success bg-opacity-10 text-success">{v.category}</div>
        //                                                             </td>
        //                                                             {/* Price item */}
        //                                                             <td>{v.price}</td>
        //                                                             <td>{v.isactive}</td>
